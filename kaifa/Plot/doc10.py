...
class allCallerSimple():
    ...
    def fill_basicinfo(self,BasicInfo):
        ...
        if n == 0:
            msi_mean = '未检测到长度变异'
            msi_des = RichText(
                '\n＊微卫星不稳定系统地比较了肿瘤和正常组织中串联重复序列的长度变异情况，根据变异程度划分为微卫星不稳定性高、低和微卫星稳定，其中微卫星不稳定性高的患者具有较好的免疫治疗预后，MSI的本次检测结果为微卫星稳定，即MSS；',
                style='HLAMeanStyle')
        if n==1:
            msi_mean ='检测到1个标记长度变异'
            msi_des =RichText(
                '\n＊微卫星不稳定系统地比较了肿瘤和正常组织中串联重复序列的长度变异情况，根据变异程度划分为微卫星不稳定性高、低和微卫星稳定，其中微卫星不稳定性高的患者具有较好的免疫治疗预后，MSI的本次检测结果为微卫星不稳定性低，即MSI-L；',
                style='HLAMeanStyle')
        if n >=2:
            msi_mean = '检测到2个或以上标记长度变异'
            msi_des =RichText(
    ...
    def medication(self):
        ...
        # print (mmr_mean)
        # print (tmb_mean)
        if ((realMSI == 'MSI-H'and mmr_mean == "异常")or (realMSI =='MSI-H' and mmr_mean =='正常') or ((realMSI =='MSI-S' or realMSI == 'MSS' or realMSI =='MSI-L') and mmr_mean == '异常') )and tmb_mean == '高':
            ...
            Nivolumab_mean.add('• 临床试验表明在过度治疗的非小细胞肺癌患者中，使用Nivolumab治疗可获得良好的治疗效果（NCT00730639）；\n',
                               style="HLAMeanStyle")
            Nivolumab_mean.add('• 国内正在开展的临床试验：亚洲非小细胞肺癌患者接受二线Nivolumab单药治疗安全性研究(CTR20171020)；\n',
                               style="HLAMeanStyle")
            Nivolumab_mean.add('• 国内正在开展的临床试验：Nivolumab或Nivolumab联合伊匹木单抗或安慰剂的III 期研究(CTR20170694)；\n',
                               style="HLAMeanStyle")
            Nivolumab_mean.add('• 国内正在开展的临床试验：Nivolumab联合治疗EGFR突变阳性的晚期非小细胞肺癌的开放随机试验(CTR20170541)；\n',
                               style="HLAMeanStyle")
            Nivolumab_mean.add('• 国内正在开展的临床试验：Nivo+Ipi/铂类对比化疗一线治疗非小肺癌患者III期试验(CTR20170340)。',
                               style="HLAMeanStyle")
            ...
            Pembrolizumab_mean.add('• 临床试验显示先期放疗的帕姆单抗治疗的晚期非小细胞肺癌患者与先期未经放疗的帕姆单抗治疗的晚期非小细胞肺癌患者相比，具有更长的无进展生存期和整体生存期（KEYNOTE-001b）；\n',
                style="HLAMeanStyle")
            Pembrolizumab_mean.add('• 国内正在开展的临床试验：化疗联合或不联合pembrolizumab在转移性鳞状非小细胞肺癌一线治疗(CTR20170044)；\n',
                style="HLAMeanStyle")
            Pembrolizumab_mean.add('• 国内正在开展的临床试验：Pembrolizumab对比多西他赛作为非小细胞肺癌的二线治疗(CTR20160205)。',
                style="HLAMeanStyle")
            ...
            Atezolizumab_mean.add('• FDA批准在接受过先期治疗的非小细胞肺癌患者，可以考虑使用Atezolizumab进行后续治疗（OAK）；\n',
                                  style="HLAMeanStyle")
            Atezolizumab_mean.add('• 国内正在开展的临床试验：初治晚期或复发性或转移性非小细胞肺癌患者的ATEZOLIZUMAB研究(CTR20171629)；\n',
                                  style="HLAMeanStyle")
            Atezolizumab_mean.add('• 国内正在开展的临床试验：评价Atezolizumab联合化疗和培美曲塞治疗非小细胞肺癌的研究(CTR20170064)；\n',
                                  style="HLAMeanStyle")
            Atezolizumab_mean.add('• 国内正在开展的临床试验：比较Atezolizumab与铂类和化疗联合治疗PD-L1高表达初治IV期NSCLC的研究(CTR20160994)；\n',
                                  style="HLAMeanStyle")
            Atezolizumab_mean.add('• 国内正在开展的临床试验：卡铂加依托泊苷伴或不伴抗PD-L1抗体治疗广泛期小细胞肺癌(CTR20160988)；\n',
                                  style="HLAMeanStyle")
            Atezolizumab_mean.add('• 国内正在开展的临床试验：Atezolizumab 对比最佳支持治疗作为非小细胞肺癌患者辅助治疗的试验(CTR20160510)。',
                                  style="HLAMeanStyle")
        ...
        #     1
        if ((realMSI == 'MSI-H'and mmr_mean == '异常') or (realMSI =='MSI-H' and mmr_mean == '正常') or ((realMSI =='MSI-S' or realMSI == "MSS" or realMSI =='MSI-L') and mmr_mean == '异常')) and (tmb_mean == '低' or tmb_mean == '中'):
            ...
            Pembrolizumab_mean.add(
                ...
                style="HLAMeanStyle")
            Pembrolizumab_mean.add(
                '• 国内正在开展的临床试验：化疗联合或不联合pembrolizumab在转移性鳞状非小细胞肺癌一线治疗(CTR20170044)；\n',
                style="HLAMeanStyle")
            Pembrolizumab_mean.add(
                '• 国内正在开展的临床试验：Pembrolizumab对比多西他赛作为非小细胞肺癌的二线治疗(CTR20160205)。',
                style="HLAMeanStyle")
            ...
            Atezolizumab_mean.add(
                ...
                style="HLAMeanStyle")
            Atezolizumab_mean.add(
                '• 国内正在开展的临床试验：初治晚期或复发性或转移性非小细胞肺癌患者的ATEZOLIZUMAB研究(CTR20171629)；\n',
                style="HLAMeanStyle")
            Atezolizumab_mean.add(
                '• 国内正在开展的临床试验：评价Atezolizumab联合化疗和培美曲塞治疗非小细胞肺癌的研究(CTR20170064)；\n',
                style="HLAMeanStyle")
            Atezolizumab_mean.add(
                '• 国内正在开展的临床试验：比较Atezolizumab与铂类和化疗联合治疗PD-L1高表达初治IV期NSCLC的研究(CTR20160994)；\n',
                style="HLAMeanStyle")
            Atezolizumab_mean.add(
                '• 国内正在开展的临床试验：卡铂加依托泊苷伴或不伴抗PD-L1抗体治疗广泛期小细胞肺癌(CTR20160988)；\n',
                style="HLAMeanStyle")
            Atezolizumab_mean.add(
                '• 国内正在开展的临床试验：Atezolizumab 对比最佳支持治疗作为非小细胞肺癌患者辅助治疗的试验(CTR20160510)。',
                style="HLAMeanStyle")
            ...
            context = {'Nivolumab_mean': Nivolumab_mean, 'Pembrolizumab_mean': Pembrolizumab_mean,
                       ...
                       'medicine_note': medicine_note}
        # 3
        if ((realMSI == 'MSI-S' or realMSI == 'MSS' or realMSI == 'MSI-L')and mmr_mean =='正常') and tmb_mean =='高' :
            Nivolumab_mean = RichText(
                '• 临床试验表明PD-L1表达（TPS>=5%）的非小细胞肺癌晚期患者接受Nivolumab治疗，并未获得比化疗更长的无进展生存期和整体生存期（CheckMate-026a）；\n',
                style="HLAMeanStyle")
            Nivolumab_mean.add(
            ...
            Nivolumab_mean.add(
                ...
                style="HLAMeanStyle")
            Nivolumab_mean.add(
                '• 国内正在开展的临床试验：亚洲非小细胞肺癌患者接受二线Nivolumab单药治疗安全性研究(CTR20171020)；\n',
                style="HLAMeanStyle")
            Nivolumab_mean.add(
                '• 国内正在开展的临床试验：Nivolumab或Nivolumab联合伊匹木单抗或安慰剂的III 期研究(CTR20170694)；\n',
                style="HLAMeanStyle")
            Nivolumab_mean.add(
                '• 国内正在开展的临床试验：Nivolumab联合治疗EGFR突变阳性的晚期非小细胞肺癌的开放随机试验(CTR20170541)；\n',
                style="HLAMeanStyle")
            Nivolumab_mean.add(
                '• 国内正在开展的临床试验：Nivo+Ipi/铂类对比化疗一线治疗非小肺癌患者III期试验(CTR20170340)。',
                style="HLAMeanStyle")
            ...
            context = {'Nivolumab_mean': Nivolumab_mean, 'Pembrolizumab_mean': Pembrolizumab_mean,
                       ...
                       'medicine_note': medicine_note}
            # 4
        if ((realMSI == 'MSI-S' or realMSI=='MSS' or realMSI =='MSI-L') and mmr_mean =='正常') and (tmb_mean == '低' or tmb_mean == '中'):
            Nivolumab_mean = RichText(
                '• 临床试验表明PD-L1表达（TPS>=5%）的非小细胞肺癌晚期患者接受Nivolumab治疗，并未获得比化疗更长的无进展生存期和整体生存期（CheckMate-026a）；\n',
                style="HLAMeanStyle")
            Nivolumab_mean.add(
            ...
            Durvalumab_mean.add(
                ...
                style="HLAMeanStyle")
            Durvalumab_mean.add(
                '• 非国内正在开展的临床试验：Durvalumab用于一线非小细胞肺癌的研究(CTR20170012)。',
                style="HLAMeanStyle")
