...
class allCallerSimple():
    ...
    def fillqc(self):
        global context
        QCInst = FileIter("/disk/lulu/autoreport/material/QC.txt")
        for QCItem in QCInst:
            context = {'read':QCItem[0], 'depth': QCItem[1], 'cover': QCItem[2]}

    def fillpathway(self):
        global context
        pathway_path = "/disk/lulu/autoreport/material/CM0013-1T.pathway.png"
        realpathway_path =InlineImage(doc,pathway_path,height=Mm(73.3),width=Mm(146.5))
