...
'''断点区域校正
    前11列是原始CBS，后11列是校正后的CBS，并且还有校正后CBS区域的pair_reads支持度'''
...
def count_bp(inputItem):
    ...
    # print realinputItem
    if realinputItem:
        # print yuanshi_inputItem
        # print yuanshi_inputItem+realinputItem
        return yuanshi_inputItem+realinputItem
